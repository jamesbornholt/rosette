...
(struct inode-op (ino) #:transparent)
(struct i-dir-add inode-op (fd) #:transparent)
(struct i-dir-rename inode-op (dst) #:transparent)
(struct i-file-write inode-op (content offset) #:transparent)
(struct i-swap inode-op (enabled) #:transparent)
(struct i-file-setsize inode-op (size) #:transparent)
(struct i-file-extend inode-op (content offset size) #:transparent)
